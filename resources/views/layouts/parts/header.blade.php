    ...
    <nav data-aos="zoom-out" data-aos-delay="800" class="navbar navbar-expand">
        <div class="container header">
            ...
            <a class="navbar-brand" href="/">
                <img src="{{ asset('images/logo.png')}}" alt="Theorem Realty 91">
            </a>
            ...
            <ul class="navbar-nav items">
                ...
                <li class="nav-item dropdown">
                    ...
                    <ul class="dropdown-menu">
                    <li><a href="#" class="nav-link">Project1 <!--<i class="icon-arrow-down"></i>--></a></li>
                    <li><a href="#" class="nav-link">Project2 <!--<i class="icon-arrow-down"></i>--></a></li>
                    <li><a href="#" class="nav-link">Project3 <!--<i class="icon-arrow-down"></i>--></a></li>
                    <li><a href="#" class="nav-link">Project4 <!--<i class="icon-arrow-down"></i>--></a></li>
</ul>
</li>
            ...
            <ul class="navbar-nav action">
                <li class="nav-item ml-3">
                    <a href="contact" target="_blank" class="btn ml-lg-auto dark-button"><i class="icon-rocket"></i>Contact Us</a>
                    <!-- 
