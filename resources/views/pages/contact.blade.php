            ...
            <div class="swiper-container no-slider slider-h-75">
                <div class="swiper-wrapper">
                    ...
                    <div class="swiper-slide slide-center">
                        ...
                        <img src="images/c1.webp" class="full-image" data-mask="70">
                ...
                <form action="php/form.php" id="leverage-form" class="multi-step-form">
                    ...
                    <div class="row">
                        ...
                        <div class="content-images col-12 col-md-6 pl-md-5 d-none d-md-block">
                            ...
                            <!-- Step 1 -->
							<div class="gallery">
                                <a class="step-image" data-poster="images/a3.png" href="">
                                    <i class="play-video icon-control-play"></i>
                                    <div class="mask-radius"></div>
                                    <img src="images/a3.png" class="fit-image" alt="Contact Us">
                                </a>
                            </div>
							...
							<div class="gallery">
                                <a class="step-image" href="assets/images/about-6.jpg">
                                    <img src="images/a1.png" class="fit-image" alt="Contact Us">
                                </a>
                            </div>
							...
							<div class="gallery">
                                <a class="step-image" href="images/about-7.jpg">
                                    <img src="images/a2.png" class="fit-image" alt="Contact Us">
                                </a>
                            </div>
